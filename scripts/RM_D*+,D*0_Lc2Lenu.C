...
void RM()
{
    ...
    Ntot +=  ch1dat -> Draw("rmx>>+hdat","lcp2dlab>0.6 && lcch==3 && abs(ml-1.11568)<0.003 && ((tag==3 && ((dstch==1 && abs(mdst-2.01026)<0.002 && abs(md-1.86483)<0.015 && (abs(mks-0.497611)<0.0075 || (dch!=3 && dch!=6)))) || (dstch==2 && abs(mdst-2.01026)<0.002 && abs(md-1.86965)<0.015 && (abs(mks-0.497611)<0.0075 || (dch!=2 && dch!=3)))) || (tag==4 && dstch==1 && abs(mdst-2.00685)<0.002 && abs(md-1.86483)<0.015 && (abs(mks-0.497611)<0.0075 || (dch!=3 && dch!=6))))","goff");
    ...
    */
    ...
    tstatfit -> SetTextAngle(0);
       tstatfit -> DrawLatex(0.67, 0.45, "#Lambda_{c}^{+}#rightarrow#Lambdae^{+}#nu_{e}"); 
