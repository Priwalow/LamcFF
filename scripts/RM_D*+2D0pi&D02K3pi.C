...
void RM()
{
    ...
    double D_mean = 1.8651, D_sigma = 0.0051, Dst_mean = 2.010, Dst_sigma = 0.0011, rsbwidth = 0.0048;
    ...
    Ntot = ch1dat -> Draw("rmx>>+hdat","tag==3 && dch==2 && dstch==1"+Dst_D_window+Mwindow,"goff"); //"lcch == 1 && ml>1.1 && ml<1.12"
    ch1dat -> Draw("rmx>>+hrsb","tag==3 && dch==2 && dstch==1"+Dst_rightsb+Mwindow,"goff");
