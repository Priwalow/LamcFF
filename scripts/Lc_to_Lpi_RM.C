{
    ...
    Ntot = ch1dat -> Draw("rmx>>+hdat","lcch == 1 && tag!=2 && abs(ml-1.11568)<0.003 && ((tag!=11 && tag!=12) || abs(ml1-1.11568)<0.003) && abs(mlc-2.2876)<0.0165"+Mwindow,"goff"); //"lcch == 1 && ml>1.1 && ml<1.12"
    ...
    fdat -> SetParameters(50,MLambdac,0.1,15,300,20);
