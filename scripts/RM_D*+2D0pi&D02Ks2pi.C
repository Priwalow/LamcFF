...
void RM()
{
    ...
    double hwidth = rend-lend, binw = hwidth/Nbins;
     ...
     double D_mean = 1.8652, D_sigma = 0.0055, Dst_mean = 2.010, Dst_sigma = 0.0012, rsbwidth = 0.00542;
    ...
    Ntot = ch1dat -> Draw("rmx>>+hdat","tag==3 && dch==3 && dstch==1"+Dst_D_window+Mwindow,"goff"); //"lcch == 1 && ml>1.1 && ml<1.12"
    ch1dat -> Draw("rmx>>+hrsb","tag==3 && dch==3 && dstch==1"+Dst_rightsb+Mwindow,"goff");;
