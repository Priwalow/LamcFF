...
void RM()
{
    ...
    double hwidth = rend-lend, binw = hwidth/Nbins;
     ...
     double D_mean = 1.8648, D_sigma = 0.0068, Dst_mean = 2.010, Dst_sigma = 0.0015, rsbwidth = 0.00591;
    ...
    Ntot = ch1dat -> Draw("rmx>>+hdat","tag==3 && dch==6 && dstch==1"+Dst_D_window+Mwindow,"goff"); //"lcch == 1 && ml>1.1 && ml<1.12"
    ch1dat -> Draw("rmx>>+hrsb","tag==3 && dch==6 && dstch==1"+Dst_rightsb+Mwindow,"goff");;
