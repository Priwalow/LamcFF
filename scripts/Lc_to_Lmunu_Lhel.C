{
    ...
    Ntot = ch1dat -> Draw("hl>>hdat","lcch == 4 && abs(ml-1.11568)<0.003 && ((tag!=11 && tag!=12) || abs(ml1-1.11568)<0.003) && mlc < 2.13 && plept>0.7 && abs(lepcost)<0.7 && fox>0.2 && plc>1.4 && abs(rmx-2.2965)<0.0466*2 && abs(rmvis*rmvis)<0.05","goff"); //"((tag!=11 && tag!=12) || abs(ml1-1.11568)<0.003)
    ch1dat -> Draw("hl>>hsb","lcch == 4 && abs(ml-1.11568)<0.003 && ((tag!=11 && tag!=12) || abs(ml1-1.11568)<0.003) && mlc < 2.13 && plept>0.7 && abs(lepcost)<0.7 && fox>0.2 && plc>1.4 && abs(rmx-2.2965)<0.0466*2 && abs(rmvis*rmvis)>0.15 && abs(rmvis*rmvis)<0.20","goff"); //abs(rmx-2.2969)>0.0468*3 && abs(rmx-2.2969)<0.0468*5
