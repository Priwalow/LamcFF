...
void RM()
{
    ...
    double D_mean = 1.8651, D_sigma = 0.0051;
    ...
    Ntot = ch1dat -> Draw("rmx>>+hdat","tag==1 && dch==2"+D_window+Mwindow,"goff"); //"lcch == 1 && ml>1.1 && ml<1.12"
    ch1dat -> Draw("rmx>>+hsb","tag==1 && dch==2"+D_sb+Mwindow,"goff");
