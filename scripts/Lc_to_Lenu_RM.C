{
    ...
    Ntot = ch1dat -> Draw("rmx>>+hdat","lcch == 3 && tag==1 && abs(ml-1.1156)<0.002"+Mwindow,"goff"); //"lcch == 1 && ml>1.1 && ml<1.12"
    ch1dat -> Draw("rmx>>+hws","lcch == 300 && tag==1 && abs(ml-1.1156)<0.002"+Mwindow,"goff");
