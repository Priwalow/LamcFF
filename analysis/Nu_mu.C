{
    ...
    Ntot = ch1dat -> Draw("rm*fabs(rm)>>hdat","lcch == 4 && m*m-10.58*10.58+2*10.58*p-rm*rm > -10 && m*m-10.58*10.58+2*10.58*p-rm*rm < 10 && p>0.1"+Mwindow,"goff");  //"lcch == 4 && m*m-10.58*10.58+2*10.58*p-rm*rm > -2 && 
																																						//m*m-10.58*10.58+2*10.58*p-rm*rm < 2"
