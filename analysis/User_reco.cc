...
namespace Belle {
	void User_reco::hist_def( void )
	{
		...
		t1 = BASF_Histogram->ntuple ("data","tag dch dstch ml md rmx rmvis px npi ngamma fox pvis ecms hlc hl hw chi" ); // not ALL momenta in CMS! 	lepton cosTheta in CMS, rholam, rholamcms	
